...
from core.views import DashboardView, IndexView, OpenTicketView, ClosedTicketView, UsersView, ImportDataView, \
    CustomPasswordChangeView, ImportUsersView, ImportDataHistoryView, ImportUsersHistoryView
...
urlpatterns = [
    ...
    path('dashboard/import-data-history', ImportDataHistoryView.as_view(), name='admin-import-data-history'),
    path('dashboard/import-users-history', ImportUsersHistoryView.as_view(), name='admin-import-users-history'),
